...
public class PelinSaannot {
  ...
  public void kerrosaannot() {
    ...
    JOptionPane.showMessageDialog(null,
                "                               PELIN YLEISET OHJEET\n"
                + "Tullessasi kasinolle sinulla on mukanasi 500 euroa. \n"
                + "Voidaksesi pelata, sinun pitää vaihtaa osa rahoistasi \n"
                + "chipeiksi. Chipit ovat kasinon peleissä käytettävä valuutta. \n"
                + "Valuutan vaihto tapahtuu Kassalla. \n\n"
